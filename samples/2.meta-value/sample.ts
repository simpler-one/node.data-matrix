...
const tests = buildDataMatrix<Test>(
    [
        ...
        ['',     $0,    $0,         $0,     null,   '[Error] Empty "from"'],
        [$0,     'Hell',$0,         $0,     null,   '[Error] Unknown "to"'],
        [$0,     $0,    'teleport', $0,     null,   '[Error] Unsupported "type"'],
        [$0,     $0,    $0,         -1,     null,   '[Error] Negative "weight"'],
        [$0,     $0,    $0,         9999,   null,   '[Error] Over "weight"'],
    ]
);
